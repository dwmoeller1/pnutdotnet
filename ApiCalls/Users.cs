    ...
    public static class Users
    {
        public static Tuple<User, ApiCallResponse> getUserByUsernameOrId(string access_token, string usernameOrId, Parameters parameter = null)
        {
            ...
            try
            {
                ...
                string requestUrl = Common.baseUrl + "/users/" + Common.formatUserIdOrUsername(usernameOrId);
                if (parameter != null)
                {
        ...
        public static Tuple<List<User>,ApiCallResponse> getFollowingsOfUser(string access_token, string usernameOrId, Parameters parameter = null)
        {
            ...
            try
            {
                ...
                string requestUrl = Common.baseUrl + "/users/" + Common.formatUserIdOrUsername(usernameOrId) + "/following";
                if (parameter != null)
                {
                    requestUrl += "?" + parameter.getQueryString();
                }
        ...
        public static Tuple<List<User>, ApiCallResponse> getFollowersOfUser(string access_token, string usernameOrId, Parameters parameter = null)
        {
            ...
            try
            {
                ...
                string requestUrl = Common.baseUrl + "/users/" + Common.formatUserIdOrUsername(usernameOrId) + "/followers";
                if (parameter != null)
                {
                    requestUrl += "?" + parameter.getQueryString();
                }
        ...
        public static Tuple<List<User>,ApiCallResponse> getMutedUsers(string access_token, string userNameOrId = "me")
        {
            ...
            try
            {
                ...
                string requestUrl = Common.baseUrl + "/users/" + userNameOrId + "/muted";
                Dictionary<string, string> headers = new Dictionary<string, string>();
                headers.Add("Authorization", "Bearer " + access_token);
                Helper.Response response = Helper.SendGetRequest(requestUrl, headers);
        ...
        public static Tuple<List<User>,ApiCallResponse> searchUsers(string access_token, string searchString, Parameters parameter = null)
        {
            ...
            try
            {
                ...
                string requestUrl = Common.baseUrl + "/users/search?q=" + System.Web.HttpUtility.HtmlEncode(searchString);
                if (parameter != null)
                {
                    requestUrl += "?" + parameter.getQueryString();
                }
        ...
        public static Tuple<List<User>, ApiCallResponse> getRepostersOfPost(string access_token, string postId, Parameters parameter = null)
        {
            ...
            try
            {
                ...
                string requestUrl = Common.baseUrl + "/posts/" + postId + "/reposters";
                if (parameter != null)
                {
                    requestUrl += "?" + parameter.getQueryString();
                }
